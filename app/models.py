...
class FollowUp(db.Model):
    ...
    overall_problem = db.Column(db.String(500))
    #headaches
    headaches = db.Column(db.String(20))
    headaches_frequency = db.Column(db.String(140))
    headaches_length = db.Column(db.String(140))
    headaches_spots = db.Column(db.String(20))
    headaches_flashes = db.Column(db.String(20))
    headaches_medication = db.Column(db.String(140))
    ...
    fainting_frequency = db.Column(db.String(140))
    fainting_length = db.Column(db.String(140))
    seizure = db.Column(db.String(20))
    seizure_frequency = db.Column(db.String(140))
    seizure_length = db.Column(db.String(140))
    seizure_medication = db.Column(db.String(140))
    ...
    tremors_positions = db.Column(db.String(140))
    ...
    episodes_of_confusion_optional = db.Column(db.String(140))
    memory_problems = db.Column(db.String(20))
    hospital_recently = db.Column(db.String(20))
    hospital_recently_optional = db.Column(db.String(140))
    medication_change = db.Column(db.String(20))
    medication_change_optional = db.Column(db.String(140))
...
class Form(db.Model):
    ...
    referred_by = db.Column(db.String(140))
    reason_for_visit = db.Column(db.String(140))
    #symptoms
    limb_jerking = db.Column(db.String(20))
    tremors = db.Column(db.String(20))
    ...
    hospital_recently= db.Column(db.String(20))
    medication_change = db.Column(db.String(20))
    other_symptoms = db.Column(db.String(140))
    #conditions
    ...
    cigarettes_long = db.Column(db.String(140))
    cigarettes_frequency = db.Column(db.String(140))
    ...
    #extra
    elaborate = db.Column(db.String(140))
    #misc
    occupation = db.Column(db.String(140))
    surgeries = db.Column(db.String(140))
    medication_allergies = db.Column(db.String(140))
    family_medical_problems = db.Column(db.String(140))
    current_medications = db.Column(db.String(140))
